        ...
        <CardContent sx={{ overflowY: "auto", maxHeight: "60vh" }}>
          ...
          {hasValue(building.customer) && (
            <Typography variant="body1">
              ...
              {createAgentLink(building.customer as string)}
            </Typography>
          )}
          {hasValue(building.operatedBy) && (
            <Typography variant="body1">
              <strong>Operated By:</strong>{" "}
              {createAgentLink(building.operatedBy as string)}
            </Typography>
          )}
          ...
          {hasValue(building.investor) && (
            <Typography variant="body1">
              ...
              {createAgentLink(building.investor as string)}
            </Typography>
          )}
          ...
          {hasValue(building.energyCertificate) && (
            <Typography variant="body1">
              <strong>Energy Certificate:</strong> {createEnergyCertificateLink(
          ...
          {building.sourceRole === "investor" && (
            <>
              ...
              {building["officeSocialArea"] != null && (
                <Typography variant="body1">
                  <strong>Office & Social Area:</strong>{" "}
                  {building["officeSocialArea"]} m²
                </Typography>
              )}
              {building["buildingHeight"] != null && (
                <Typography variant="body1">
                  <strong>Building Height:</strong> {building["buildingHeight"]}
                  {" "}
                  m
                </Typography>
              )}
              ...
              {hasValue(building["indoorTemperatureClass"]) && (
                <Typography variant="body1">
                  <strong>Indoor Temperature:</strong>{" "}
                ...
                <>
                  ...
                  {building["hasHeatPump"] != null && (
                    <Typography
                      ...
                      variant="body1"
                    >
                      <strong>Heat Pump:</strong> {building["hasHeatPump"]
                        ? <CheckIcon fontSize="small" />
                        : <ClearIcon fontSize="small" />}
                    </Typography>
                  )}
                  {building["hasGasBoiler"] != null && (
                    <Typography
                      ...
                      variant="body1"
                    >
                      <strong>Gas Boiler:</strong> {building["hasGasBoiler"]
                        ? <CheckIcon fontSize="small" />
                        : <ClearIcon fontSize="small" />}
                    </Typography>
                  )}
                  {building["hasOilBoiler"] != null && (
                    <Typography
                      ...
                      variant="body1"
                    >
                      <strong>Oil Boiler:</strong> {building["hasOilBoiler"]
                        ? <CheckIcon fontSize="small" />
                        : <ClearIcon fontSize="small" />}
                    </Typography>
                  )}
                    ...
                    {(building["certifications"] as InvestorCertification[])
                      .map((cert, i) => (
                        <Typography key={i} variant="body1">
                          <strong>{cert.type}:</strong> {cert.level}
