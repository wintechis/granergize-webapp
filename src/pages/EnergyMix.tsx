...
export default function EnergyMix() {
  ...
  const [orderConsumptionBy, setOrderConsumptionBy] = useState<
    "name" | keyof EnergyConsumption
  >("value");
  ...
  const [orderProductionBy, setOrderProductionBy] = useState<
    "name" | keyof EnergyProduction
    ...
    <Box sx={{ padding: 2 }}>
      ...
      <EnergyTable<EnergyConsumption>
        ...
        onRequestSort={(property) => {
          const isAsc = orderConsumptionBy === property &&
            consumptionOrder === "asc";
      ...
      <EnergyTable<EnergyProduction>
        ...
        onRequestSort={(property) => {
          const isAsc = orderProductionBy === property &&
            productionOrder === "asc";
